                    ...
                    <div class="in_box">
                            ...
                            <table class="default">
                                ...
                                <col>
                                    ...
                                    <th>数据库地址</th><td><input class="gray" type="text" name="db_address" value="127.0.0.1"> <label>MYSQL数据库的地址，本地默认：127.0.0.1</label></td>
                                </tr>
                                <tr>
                                    <th>端口</th><td><input class="gray" type="text" name="db_port" value="3306"> <label>默认3306</label></td>
                                </tr>
                                <tr>
    ...
    {
        var sendData = {'db_address':'','db_user':'','db_pwd':'','db_port':'3306'};
        for(val in sendData)
        {
